-- =============================================
-- Class stats: change total_vocab_words from "mastered" to "wordbank size"
-- Removes the mastery_level >= 3 filter so the chip reflects the total
-- vocabulary exposure for the class (all words ever practiced).
-- =============================================
