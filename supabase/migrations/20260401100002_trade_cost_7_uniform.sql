-- Update trade costs to uniform 7 for all rarity tiers
...
BEGIN
    ...
    -- Determine source rarity (required count is always 7)
    CASE p_target_rarity
        WHEN 'rare' THEN v_source_rarity := 'common';
        WHEN 'epic' THEN v_source_rarity := 'rare';
        WHEN 'legendary' THEN v_source_rarity := 'epic';
