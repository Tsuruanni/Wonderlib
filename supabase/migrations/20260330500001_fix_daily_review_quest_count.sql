-- Fix: daily_review quest due word count should match get_due_review_words RPC.
-- Previous: counted vocabulary_progress rows directly (may include orphan rows)
-- Now: counts via JOIN to vocabulary_words (matches what client sees)
-- Also aligns claim_daily_bonus with same logic.

-- =============================================
-- A. get_daily_quest_progress — fix due word count
-- =============================================
...
-- =============================================
-- B. claim_daily_bonus — same fix for due word count
-- =============================================
