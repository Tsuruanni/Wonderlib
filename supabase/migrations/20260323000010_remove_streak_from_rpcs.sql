-- Remove PERFORM update_user_streak() from complete_daily_review and complete_vocabulary_session.
-- Streak is now login-based (checked on app open), not activity-based.
-- These server-side calls were redundant (idempotent same-day no-ops) and confusing.

-- 1. complete_daily_review — remove streak call (line 427 in 000006)
...
-- 2. complete_vocabulary_session — remove streak call (line 636 in 000006)
