-- Add previous_streak to update_user_streak return type
-- Needed for tiered "streak broken" notification messages
...
BEGIN
    ...
    -- v_current_streak = the streak BEFORE this call (what was broken/extended)
