-- Migration: Update complete_vocabulary_session to read bonuses from system_settings
-- Instead of hardcoded v_session_bonus := 10 and v_perfect_bonus := 20,
-- read from system_settings with fallback defaults.
