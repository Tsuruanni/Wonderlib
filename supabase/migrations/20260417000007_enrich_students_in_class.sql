-- =============================================
-- get_students_in_class (used by the Class Students screen) was missing
-- the fields added elsewhere: league_tier, avatar_equipped_cache,
-- wordbank_size. Also add last_activity_date so teachers can see which
-- students are inactive.
-- =============================================

DROP FUNCTION IF EXISTS get_students_in_class(UUID);
CREATE FUNCTION get_students_in_class(p_class_id UUID)
RETURNS TABLE (
  id UUID,
  first_name TEXT,
  last_name TEXT,
