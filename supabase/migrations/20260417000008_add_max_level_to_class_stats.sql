-- =============================================
-- Add max_level to get_classes_with_stats so the Class Overview header
-- can show "Top Level" (highest student level in the school).
-- =============================================
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(MAX(p.level), 0)::INT as max_level,
    c.created_at
  FROM classes c
