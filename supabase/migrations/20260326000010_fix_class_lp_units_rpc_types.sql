-- Fix type mismatch in get_class_learning_path_units:
-- ARRAY_AGG returns VARCHAR[] but RETURNS TABLE expects TEXT[]
-- Add explicit cast to fix "structure of query does not match function result type"
