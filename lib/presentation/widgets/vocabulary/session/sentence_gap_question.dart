...
class SentenceGapQuestion extends StatefulWidget {
  const SentenceGapQuestion({
    super.key,
  ...
  @override
  State<SentenceGapQuestion> createState() => _SentenceGapQuestionState();
}

class _SentenceGapQuestionState extends State<SentenceGapQuestion> {
