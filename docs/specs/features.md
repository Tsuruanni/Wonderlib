...
| 11 | **Badge/Achievement** | Badge editor (condition types, thresholds, XP rewards, categories) | Auto-award, badge collection display | Badge list per student | Medium | Done: `docs/specs/11-badge-achievement.md` |
