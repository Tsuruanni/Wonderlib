              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _DashboardCard(
                    icon: Icons.abc,
                    title: 'Kelimeler',
                    description: 'Kelime sözlüğü yönetimi',
                  ...
                  _DashboardCard(
                    ...
                    description: 'Kelime koleksiyonu yönetimi',
                  ...
                  _DashboardCard(
                    icon: Icons.layers,
                    title: 'Üniteler',
                    description: 'Kelime üniteleri yönetimi',
                  ...
                  _DashboardCard(
                    icon: Icons.star,
                    title: 'XP Ayarları',
                    description: 'XP, seviye ve oyun ayarları',
                    color: const Color(0xFFF59E0B),
                    onTap: () => context.go('/xp-settings'),
                  ),
                  _DashboardCard(
                    icon: Icons.settings_applications,
                    title: 'Uygulama Ayarları',
                    description: 'Bakım modu, versiyon, özellikler',
