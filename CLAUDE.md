...
| Avatar System | `docs/specs/16-avatar-system.md` | Human avatar (male/female), 9 part categories, gender filtering, required categories, onboarding setup, 500-coin gender change, z-index layering, per-gender outfit memory, admin catalog CRUD |
...
| Notification System | `docs/specs/24-notification-system.md` | 8 notification types, event-driven dialog queue, admin toggle gallery, settings-gated display, streak/badge/level/league/assignment events |
| Content Blocks | `docs/specs/25-content-blocks.md` | Block types (text/image/activity), progressive reveal, word-level audio sync, cache-aside offline, admin editor, JSON import, legacy bridge |
